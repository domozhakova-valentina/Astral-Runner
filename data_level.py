...
level_4 = {
		...
		'obstacles_folder': 'graphics/obstacles/cutting_disc',
		'limitations_enemy': 'levels/4/4_level_limitations_monsters.csv',
		'enemies': 'levels/4/4_level_monsters.csv',
		'limitations_tiles': 'levels/4/4_level_limitations_tiles.csv',
		'mobile_tiles': 'levels/4/4_level_mobile_tiles.csv',
